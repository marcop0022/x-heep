...
// the pad `inout wire`s. It was the toplevel of the former `asic_yosys_synthesis` target (now asic_yosys_ihp130, whose top is generated by generate_xif_tieoff_wrapper.py).
//
