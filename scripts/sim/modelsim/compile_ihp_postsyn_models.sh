...
# vlog-compiles them into the `work` library before the rest of the sources.
#
...
echo "[compile_ihp_postsyn_models] Compiling ${#MODEL_FILES[@]} PDK model file(s):"
printf '  %s\n' "${MODEL_FILES[@]}"

vlog -work work "${MODEL_FILES[@]}"
