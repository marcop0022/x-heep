...
#
# Run by `make <tool>-<tech>-stage-netlist` (NOT a fusesoc pre_build hook:
...
OUT = Path("implementation/postsynth/x_heep_system_postsyn_sim_shim.sv")
...
// (via `make <tool>-<tech>-stage-netlist`).
//
